# Пакет компонента Import входит в состав GM Framework.

Пакет компонента Import предназанчен для импорта пакета данных компонентов приложения GearMagic (модулей, расширений модулей).
